...
class CustomHealthNewsListView extends StatefulWidget {
  const CustomHealthNewsListView(
      {super.key, required this.newsData, required this.currentIndex});
  final List<NewsEntity> newsData;
  final int currentIndex;
  @override
  State<CustomHealthNewsListView> createState() =>
      _CustomHealthNewsListViewState();
}

class _CustomHealthNewsListViewState extends State<CustomHealthNewsListView> {
